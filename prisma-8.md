...
Your data contract is the heart of your application. It lives at [`src/prisma/schema.ts`](src/prisma/schema.ts) and describes your models:
...
| File | Purpose |
|---|---|
| [`src/prisma/schema.ts`](src/prisma/schema.ts) | Your data contract — define your models here |
...
1. Edit [`src/prisma/schema.ts`](src/prisma/schema.ts) to add or change models.
